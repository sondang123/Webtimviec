...
import AddJob from "./Tabs/AddJob/AddJob";
import UpdateJob from "./Tabs/UpdateJob/UpdateJob";
import UserApply from "./Tabs/UserApply/UserApply";
import Infor from "./Tabs/infor/Infor";

export default function LayoutUser({ id }) {
          ...
          <Layout className="site-layout">
            ...
            >
              <Switch>
                ...
                <Route exact path="/inforCompany/UserApply">
                  <UserApply id={id} />
                </Route>
                <Route exact path="/inforCompany/Infor">
                  <Infor id={id} />
                </Route>
              </Switch>
            </Content>
